...
def debt_details(df, category_df):
        ...
        if st.session_state.home_page == 'Settings':
            ...
            if st.button('➕ Log'):
                ...
                def add_log():
                    ...
                    amount = st.number_input('Amount', width='stretch', value=def_val)
        ...
        if filtered_df.empty:
            ...
            for i in filtered_df.index:
                ...
                with st.container(horizontal=True, horizontal_alignment='distribute'):
                    ...
                    if st.button('✏️', key=f'edit_log_{i}', width='content'):
                        st.session_state.edit_log = i
                    
                st.markdown(
                    f"""
                        <style>
                        .st-key-edit_log_{i} button{{
                            height: 100px;
                            padding: 5px;
                            margin-bottom: -100px;
                        }}  
